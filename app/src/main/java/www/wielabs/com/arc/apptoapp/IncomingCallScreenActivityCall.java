...
public class IncomingCallScreenActivityCall extends CallBaseActivity {

    static final String TAG = IncomingCallScreenActivityCall.class.getSimpleName();
    ...
    private void answerClicked() {
        mCallAudioPlayer.stopRingtone();
        Call call = getSinchServiceInterface().getCall(mCallId);
        if (call != null) {
            try {
                call.answer();
                Intent intent = new Intent(this, CallScreenActivityCall.class);
                intent.putExtra(CallSinchService.CALL_ID, mCallId);
